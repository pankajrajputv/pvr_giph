...
DEFINE VARIABLE cDir AS CHARACTER NO-UNDO INITIAL 'C:\pvr\giph\GL2019-CSV-Van1'.
...
FOR EACH det:
    IF det.cfilename MATCHES "*.csv" THEN DO:
        ...
        IF SEARCH(det.cfilename) <> ? THEN DO:
            ...
            ASSIGN pfilename  = REPLACE(pfilename,"C:\pvr\giph\GL2019-CSV-Van1","C:\pvr\giph\GL2019-CSV-Van1\TEMP").
