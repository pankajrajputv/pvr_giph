...
FOR EACH gi_data_visa_sum WHERE gi_data_visa_sum.visa-sum-cons = pvisa-sum-cons NO-LOCK
    ...
    */
    ...
    IF FIRST-OF(gi_data_visa_sum.visa-sum-cons) THEN DO:
        ...
        RUN c:\pvr\giph\lib\Calc_Vou_Date_From_Fn.p(INPUT gi_data_visa_sum.YearMonthFN,OUTPUT pvoudate).
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_visa_sum.GrossAmount1 * -1 pledgernarration = "Gross Amount / " +  STRING((gi_data_visa_sum.CollectFromAgent - gi_data_visa_sum.AgentComm),"-zz,zzz,zz9.99").
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Agent Commission - Visa" pledgeramount-debit1 = gi_data_visa_sum.agentcomm1 * -1 pledgernarration = "Agent Commission / " + STRING(gi_data_visa_sum.agentcomm1,"-zz,zzz,zz9.99").
    RUN debit_entry.
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_visa_sum.payable1 pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_visa_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Commission Income - Visa" pledgeramount-credit1 = gi_data_visa_sum.comm-income1 pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_visa_sum.GrossAmount - gi_data_visa_sum.Payable,"-zz,zzz,zz9.99"). 
