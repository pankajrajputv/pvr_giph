...
ASSIGN pbank-code = "BPI".
ASSIGN pbank-des = "BPI C/A 3793-0388-19".
...
REPEAT:
    ...
    IF tt_gi_data_banks.tran-amt >= 0 THEN DO:
        ASSIGN tt_gi_data_banks.amt-cr = tt_gi_data_banks.tran-amt.

    END.
    IF tt_gi_data_banks.tran-amt < 0 THEN DO:
        ASSIGN tt_gi_data_banks.amt-db = tt_gi_data_banks.tran-amt * -1.
    END.
