...
FOR EACH gi_data_bus_sum WHERE gi_data_bus_sum.bus-sum-cons = pbus-sum-cons NO-LOCK
    ...
    */
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_bus_sum.payable1 pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_bus_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Commission Income - Bus" pledgeramount-credit1 = gi_data_bus_sum.comm-income1 pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_bus_sum.GrossAmount - gi_data_bus_sum.Payable,"-zz,zzz,zz9.99"). 
