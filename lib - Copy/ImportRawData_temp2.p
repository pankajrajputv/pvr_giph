...
DEF STREAM a.
DEF STREAM b.
DEFINE VARIABLE cDir AS CHARACTER NO-UNDO INITIAL 'C:\pvr\giph\GL2019-CSV-Van1\temp'.
...
/*ASSIGN pdata-filename = "C:\pvr\giph\GL2019-CSV-Anna2\temp\data3.csv".*/
ASSIGN pdata-filename = "C:\pvr\giph\GL2019-CSV-Van1\temp\data3.csv".
OS-DELETE VALUE(pdata-filename).
