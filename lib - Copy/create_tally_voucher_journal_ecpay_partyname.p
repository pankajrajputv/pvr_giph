...
FOR EACH gi_data_ecpay_sum WHERE gi_data_ecpay_sum.ecpay-sum-cons = pecpay-sum-cons NO-LOCK
    ...
    */
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_ecpay_sum.TotalAmount * -1 pledgernarration = "Gross Amount / " +  STRING((gi_data_ecpay_sum.CollectFromAgent - gi_data_ecpay_sum.AgentComm),"-zz,zzz,zz9.99").
    RUN debit_entry.

    /*
    ASSIGN pledgername-debit1 = "Agent Commission - ecpay" pledgeramount-debit1 = gi_data_ecpay_sum.agentcomm1 * -1 pledgernarration = "Agent Commission / " + STRING(gi_data_ecpay_sum.agentcomm1,"-zz,zzz,zz9.99").
    RUN debit_entry.
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_ecpay_sum.PayableToOperator pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_ecpay_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.
    ...
    ASSIGN pledgername-credit1 = "Commission Income - EcPay" pledgeramount-credit1 = gi_data_ecpay_sum.profit pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_ecpay_sum.TotalAmount - gi_data_ecpay_sum.PayableToOperator,"-zz,zzz,zz9.99"). 
