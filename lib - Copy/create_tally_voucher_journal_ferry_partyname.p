...
FOR EACH gi_data_ferry_sum WHERE gi_data_ferry_sum.ferry-sum-cons = pferry-sum-cons NO-LOCK
    ...
    */
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_ferry_sum.GrossAmount1 * -1 pledgernarration = "Gross Amount / " +  STRING((gi_data_ferry_sum.CollectFromAgent - gi_data_ferry_sum.AgentComm),"-zz,zzz,zz9.99").
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Agent Commission - Ferry" pledgeramount-debit1 = gi_data_ferry_sum.agentcomm1 * -1 pledgernarration = "Agent Commission / " + STRING(gi_data_ferry_sum.agentcomm1,"-zz,zzz,zz9.99").
    RUN debit_entry.
    ...
    IF gi_data_ferry_sum.total-db-cr-diff < 0 THEN DO:
       /* ASSIGN pledgername-debit1 = "Income - Miscellaneous" pledgeramount-debit1 = gi_data_ferry_sum.total-db-cr-diff * -1 pledgernarration = "Diff Db Cr / " + STRING("").*/
        ASSIGN pledgername-debit1 = "Income - Miscellaneous" pledgeramount-debit1 = gi_data_ferry_sum.total-db-cr-diff pledgernarration = "Diff Db Cr / " + STRING("").
        RUN debit_entry.
    END.
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_ferry_sum.payable1 pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_ferry_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Commission Income - ferry" pledgeramount-credit1 = gi_data_ferry_sum.comm-income1 pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_ferry_sum.GrossAmount - gi_data_ferry_sum.Payable,"-zz,zzz,zz9.99"). 
    ...
    IF gi_data_ferry_sum.total-db-cr-diff > 0 THEN DO:
        ASSIGN pledgername-credit1 = "Income - Miscellaneous" pledgeramount-credit1 = gi_data_ferry_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN credit_entry.
    END.
