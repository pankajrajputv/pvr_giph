...
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons = pairline-sum-cons NO-LOCK
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Airlines Agent Commission" pledgeramount-debit1 = 241234.78 * -1 pledgernarration = "AAA".
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = 170587280.08 * -1 pledgernarration = "BBB".
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Input Vat @ 12%" pledgeramount-debit1 = 28948.17 * -1 pledgernarration = "CCC".
    RUN debit_entry.

    /*************** CREDIT *****************/

    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = 3067073.21. 
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Master Agent Commission Payable" pledgeramount-credit1 = 2593863.15.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Transaction Fee" pledgeramount-credit1 = 145748.21.
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Supplier Commission - Airline" pledgeramount-credit1 = 346290.38.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Ark Travel" pledgeramount-credit1 = 164214526.61.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Output Tax Payable" pledgeramount-credit1 = 427093.42.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Income - Miscellaneous" pledgeramount-credit1 = 62868.05.
    RUN credit_entry.
