...
FOR EACH gi_data_bus_sum WHERE gi_data_bus_sum.bus-sum-cons = pbus-sum-cons /*NO-LOCK*/
    ...
    */
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_bus_sum.GrossAmount1 * -1 pledgernarration = "Gross Amount / " +  STRING((gi_data_bus_sum.CollectFromAgent - gi_data_bus_sum.AgentComm),"-zz,zzz,zz9.99").
    RUN debit_entry.
    ...
    ASSIGN pledgername-credit1 = "Commission Income - Bus" pledgeramount-credit1 = gi_data_bus_sum.profit pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_bus_sum.GrossAmount - gi_data_bus_sum.Payable,"-zz,zzz,zz9.99"). 
