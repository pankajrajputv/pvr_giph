...
FOR EACH gi_data_airline /*WHERE gi_data_airline.errortxt = ""*/:
    ...
    /*
    MESSAGE gi_data_airline.Airline-Cons gi_data_airline.IssuedDate gi_data_airline.IssuedDate-txt. PAUSE 1.
      */
...
/*
FOR EACH gi_data_airline WHERE gi_data_airline.trnstype = "Total":
...
FOR EACH gi_data_airline /*WHERE gi_data_airline.issueddate >= 10/1/19 AND gi_data_airline.issueddate <= 10/31/19*/:
    ASSIGN gi_data_airline.topupamt1            = gi_data_airline.topupamt / 1.12.
    ASSIGN gi_data_airline.mtagentcomm1         = gi_data_airline.mtagentcomm.
    ASSIGN gi_data_airline.transfee1            = gi_data_airline.transfee / 1.12.
    ASSIGN gi_data_airline.agentcomm1           = gi_data_airline.agentcomm / 1.12.
    ...
    ASSIGN gi_data_airline.inputvat             = gi_data_airline.agentcomm1 * 0.12.
    ASSIGN gi_data_airline.outputvat            = (gi_data_airline.topupamt1 + gi_data_airline.transfee1 +   gi_data_airline.SupplierComm1 +  gi_data_airline.SegmentFee1) * 0.12. 
...
FOR EACH gi_data_airline /*WHERE gi_data_airline.issueddate >= 10/1/19 AND gi_data_airline.issueddate <= 10/31/19*/
    BREAK BY gi_data_airline.YearMonthFN
          BY gi_data_airline.IataStock:
    IF FIRST-OF(gi_data_airline.IataStock) THEN DO:
    ...
    FIND gi_data_airline_sum WHERE gi_data_airline_sum.YearMonthFN = gi_data_airline.YearMonthFN
                               AND gi_data_airline_sum.IataStock   = gi_data_airline.IataStock NO-ERROR.
...
FOR EACH gi_data_airline_sum:
    ...
    ASSIGN gi_data_airline_sum.airline-sum-cons = pcons.
END.
