...
*/
    ...
    END.
    IF pledgername = "Advances from Client" THEN DO:
        ASSIGN pledgername = "Control Agent".
    END.


    IF gi_acc_det.debit > 0 AND gi_acc_led.isbank THEN DO:
        ASSIGN
            pledgername-debit1    = /*"UCPB C/A PHP 201120001328"*/  pledgername
            pledgeramount-debit1  = /*4299.00*/ gi_acc_det.debit * -1
            ppaymentfovouring      = ""
            pbankpartyname         = ""
            pledgername-credit2    = ""
    ...
    END.
    ELSE DO:
        IF gi_acc_det.debit > 0 AND NOT gi_acc_led.isbank THEN DO:
            ASSIGN 
