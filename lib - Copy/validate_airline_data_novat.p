...
FOR EACH gi_data_airline /*WHERE gi_data_Airline.yearmonth = "2019-01"*/
    ...
    */
    ...
    ASSIGN
        ...
        gi_data_airline_sum.profit1              = gi_data_airline_sum.profit1           + gi_data_airline.Profit1
    ...
    ASSIGN gi_data_airline_sum.total-db              = gi_data_airline_sum.total-db            + gi_data_airline.total-db
