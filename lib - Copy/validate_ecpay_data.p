...
FOR EACH gi_data_ecpay:
    ...
    ASSIGN 
      ...
      gi_data_ecpay.AgentComm1   = gi_data_ecpay.AgentComm / 1.12
      gi_data_ecpay.InputVat     = gi_data_ecpay.AgentComm1 * 0.12
        .

    ASSIGN 
      gi_data_ecpay.Payable1     = gi_data_ecpay.PayableToOperator
      gi_data_ecpay.comm-income1 = (gi_data_ecpay.TotalAmount - gi_data_ecpay.PayableToOperator) / 1.12 
      gi_data_ecpay.OutputVat    = gi_data_ecpay.comm-income * 0.12
        .
