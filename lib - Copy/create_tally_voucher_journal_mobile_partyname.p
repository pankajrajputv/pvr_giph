...
FOR EACH gi_data_mobile_sum WHERE gi_data_mobile_sum.mobile-sum-cons = pmobile-sum-cons NO-LOCK
    ...
    */
    ...
    IF FIRST-OF(gi_data_mobile_sum.mobile-sum-cons) THEN DO:
        ...
        RUN c:\pvr\giph\lib\Calc_Vou_Date_From_Fn.p(INPUT gi_data_mobile_sum.YearMonthFN,OUTPUT pvoudate).
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_mobile_sum.GrossAmount1 * -1 pledgernarration = "Gross Amount / " +  STRING((gi_data_mobile_sum.CollectFromAgent - gi_data_mobile_sum.AgentComm),"-zz,zzz,zz9.99").
    RUN debit_entry.

    IF gi_data_mobile_sum.total-db-cr-diff < 0 THEN DO:
        ASSIGN pledgername-debit1 = "Income - Miscellaneous" pledgeramount-debit1 = gi_data_mobile_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN debit_entry.
    END.
    ...
    */
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_mobile_sum.payable1 pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_mobile_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Commission Income - mobile" pledgeramount-credit1 = gi_data_mobile_sum.comm-income1 pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_mobile_sum.GrossAmount - gi_data_mobile_sum.Payable,"-zz,zzz,zz9.99"). 
