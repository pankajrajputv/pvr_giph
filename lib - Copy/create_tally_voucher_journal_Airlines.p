DEF SHARED VAR pairline-sum1-cons LIKE gi_data_airline_sum1.airline-sum1-cons.
/*DEF NEW SHARED VAR pairline-sum1-cons LIKE gi_data_airline_sum1.airline-sum1-cons.*/
...
FOR EACH gi_data_airline_sum1 WHERE gi_data_airline_sum1.airline-sum1-cons = pairline-sum1-cons NO-LOCK
    BREAK BY gi_data_airline_sum1.airline-sum1-cons:
    
    IF FIRST-OF(gi_data_airline_sum1.airline-sum1-cons) THEN DO:
        ASSIGN pacc-ledger-name = replace(gi_data_airline_sum1.IataStock,"&","&amp;")
               pacc-ledger-parent-name = "Accounts Payable". 
        RUN CreateLedger.

        ASSIGN pacc-ledger-name = replace(gi_data_airline_sum1.AirlinesName,"&","&amp;")
               pacc-ledger-parent-name = "Accounts Payable". 
        RUN CreateLedger.

        ASSIGN 
            pvouchertype         = "Journal-Airline1"
            pvouchernumber       = /*"CDV36462"*/  STRING(gi_data_airline_sum1.airline-sum1-cons)
            pvoucherdate         = 10/31/19
            peffectivedate       = 10/31/19
            pchequedate          = 10/31/19
            pchequenumber        = /*STRING(gi_data_airline_sum1.cheque-num)*/ ""
            ...
            pnarration           = replace(gi_data_airline_sum1.IataStock,"&","&amp;")
            .
    ...
    END. /* IF FIRST-OF(gi_data_airline_sum1.airline-sum1-cons) */

    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Airlines Agent Commission" pledgeramount-debit1 = gi_data_airline_sum1.agentcomm1 * -1 pledgernarration = gi_data_airline_sum1.party-name.
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_airline_sum1.CollectFromAgent1 * -1 pledgernarration = gi_data_airline_sum1.party-name.
    RUN debit_entry.

    /*ASSIGN pledgername-debit1 = "Input Vat @ 12%" pledgeramount-debit1 = gi_data_airline_sum1.inputvat * -1 pledgernarration = "CCC".*/
    ASSIGN pledgername-debit1 = "VAT Input Tax" pledgeramount-debit1 = gi_data_airline_sum1.inputvat * -1 pledgernarration = gi_data_airline_sum1.party-name.
    RUN debit_entry.

    /*************** CREDIT *****************/

    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum1.topupamt1 pledgernarration = gi_data_airline_sum1.party-name. 
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Master Agent Commission Payable" pledgeramount-credit1 = gi_data_airline_sum1.mtagentcomm1 pledgernarration = gi_data_airline_sum1.party-name.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Transaction Fee" pledgeramount-credit1 = gi_data_airline_sum1.transfee1 pledgernarration = gi_data_airline_sum1.party-name.
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Supplier Commission - Airline" pledgeramount-credit1 = gi_data_airline_sum1.SupplierComm1  pledgernarration = gi_data_airline_sum1.party-name.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = replace(gi_data_airline_sum1.AirlinesName,"&","&amp;") pledgeramount-credit1 = gi_data_airline_sum1.PayableToAirline1 pledgernarration = gi_data_airline_sum1.party-name.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Output Tax Payable" pledgeramount-credit1 = gi_data_airline_sum1.outputvat  pledgernarration = gi_data_airline_sum1.party-name.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Income - Miscellaneous" pledgeramount-credit1 = gi_data_airline_sum1.total-db-cr-diff pledgernarration = gi_data_airline_sum1.party-name.
    RUN credit_entry.
