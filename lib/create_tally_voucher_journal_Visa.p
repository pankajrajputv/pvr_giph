...
FOR EACH gi_data_airline_sum1 WHERE gi_data_airline_sum1.airline-sum1-cons = pairline-sum1-cons NO-LOCK
    ...
    IF FIRST-OF(gi_data_airline_sum1.airline-sum1-cons) THEN DO:
        ASSIGN 
               pacc-ledger-name = replace(gi_data_airline_sum1.IataStock,"&","&amp;")
        ...
        ASSIGN 
               pacc-ledger-name = replace(gi_data_airline_sum1.alias-name,"&","&amp;")
               pacc-ledger-name-alias = replace(gi_data_airline_sum1.alias-name,"&","&amp;")
               pacc-ledger-parent-name = "Accounts Payable". 
        RUN CreateLedger.

        ASSIGN 
               pacc-ledger-name = replace(gi_data_airline_sum1.party-name,"&","&amp;")
               pacc-ledger-name-party = replace(gi_data_airline_sum1.party-name,"&","&amp;")
               pacc-ledger-parent-name = "Accounts Payable". 
        RUN CreateLedger.
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Airlines Agent Commission" pledgeramount-debit1 = gi_data_airline_sum1.agentcomm1 * -1 pledgernarration = "AAA".
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_airline_sum1.CollectFromAgent1 * -1 pledgernarration = "BBB".
    RUN debit_entry.
    ...
    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum1.topupamt1. 
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Master Agent Commission Payable" pledgeramount-credit1 = gi_data_airline_sum1.mtagentcomm1.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Transaction Fee" pledgeramount-credit1 = gi_data_airline_sum1.transfee1.
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Supplier Commission - Airline" pledgeramount-credit1 = gi_data_airline_sum1.SupplierComm1 .
    RUN credit_entry.


    ASSIGN pledgername-credit1 = replace(gi_data_airline_sum1.AirlinesName,"&","&amp;") pledgeramount-credit1 = gi_data_airline_sum1.PayableToAirline1.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Output Tax Payable" pledgeramount-credit1 = gi_data_airline_sum1.outputvat.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Income - Miscellaneous" pledgeramount-credit1 = gi_data_airline_sum1.total-db-cr-diff.
    RUN credit_entry.
