...
FOR EACH gi_data_hotel_sum WHERE gi_data_hotel_sum.hotel-sum-cons = photel-sum-cons NO-LOCK
    ...
    */
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_hotel_sum.GrossAmount1 * -1 pledgernarration = "Gross Amount / " +  STRING((gi_data_hotel_sum.CollectFromAgent),"-zz,zzz,zz9.99").
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Agent Commission - Hotel" pledgeramount-debit1 = gi_data_hotel_sum.agentcomm1 * -1 pledgernarration = "Agent Commission / " + STRING(gi_data_hotel_sum.agentcomm1,"-zz,zzz,zz9.99").
    RUN debit_entry.

    /*ASSIGN pledgername-debit1 = "Input Vat @ 12%" pledgeramount-debit1 = gi_data_hotel_sum.inputvat * -1 pledgernarration = "Input Vat".*/
    ASSIGN pledgername-debit1 = "VAT Input Tax" pledgeramount-debit1 = gi_data_hotel_sum.inputvat * -1 pledgernarration = "Input Vat".
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Master Agent Commission - Hotel" pledgeramount-debit1 = gi_data_hotel_sum.MTAgentComm1 * -1 pledgernarration = "Master Agent Comm".
    RUN debit_entry.

    IF gi_data_hotel_sum.total-db-cr-diff < 0 THEN DO:
        ASSIGN pledgername-debit1 = "Income - Miscellaneous" pledgeramount-debit1 = gi_data_hotel_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN debit_entry.
    END.

    /*************** CREDIT *****************/

    ASSIGN pledgername-credit1 = "Master Agent A/c" pledgeramount-credit1 = gi_data_hotel_sum.MTAgentComm2 pledgernarration = "Master Agent".
    RUN credit_entry.

    /*ASSIGN pledgername-credit1 = "Payable to Operate - hotel" pledgeramount-credit1 = gi_data_hotel_sum.payable1 pledgernarration = "Payable. / " /*+ STRING(gi_data_hotel_sum.mtagentcomm,"-zz,zzz,zz9.99") */.*/
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_hotel_sum.payable1 pledgernarration = "Payable to operate. / "  + pacc-ledger-name-party /*+ STRING(gi_data_hotel_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Commission Income - hotel" pledgeramount-credit1 = gi_data_hotel_sum.comm-income1 pledgernarration = "Coll from Agent + Agent Comm - Payable to Operate / " + STRING(gi_data_hotel_sum.CollectFromAgent + gi_data_hotel_sum.AgentComm - gi_data_hotel_sum.PayableToOperate,"-zz,zzz,zz9.99"). 
    /*ASSIGN pledgername-credit1 = "Hotel" pledgeramount-credit1 = gi_data_hotel_sum.comm-income1 pledgernarration = "Coll from Agent + Agent Comm - Payable to Operate / " + STRING(gi_data_hotel_sum.CollectFromAgent + gi_data_hotel_sum.AgentComm - gi_data_hotel_sum.PayableToOperate,"-zz,zzz,zz9.99"). */
    RUN credit_entry.

    /*ASSIGN pledgername-credit1 = "Output Vat @ 12%" pledgeramount-credit1 = gi_data_hotel_sum.outputvat pledgernarration = "Commission Income - hotel / x 0.12 " + STRING(gi_data_hotel_sum.comm-income1, "-zz,zzz,zz9.99").*/
    ASSIGN pledgername-credit1 = "Output Tax Payable" pledgeramount-credit1 = gi_data_hotel_sum.outputvat pledgernarration = "Commission Income - hotel / x 0.12 " + STRING(gi_data_hotel_sum.comm-income1, "-zz,zzz,zz9.99").
    RUN credit_entry.

    IF gi_data_hotel_sum.total-db-cr-diff > 0 THEN DO:
        ASSIGN pledgername-credit1 = "Income - Miscellaneous" pledgeramount-credit1 = gi_data_hotel_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN credit_entry.
    END.
