...
FOR EACH gi_data_insurance_sum WHERE gi_data_insurance_sum.insurance-sum-cons = pinsurance-sum-cons NO-LOCK
    ...
    */
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_insurance_sum.payable1 pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_insurance_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Commission Income - insurance" pledgeramount-credit1 = gi_data_insurance_sum.comm-income1 pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_insurance_sum.GrossAmount - gi_data_insurance_sum.Payable,"-zz,zzz,zz9.99"). 
