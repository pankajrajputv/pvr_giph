...
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons = pairline-sum-cons /*NO-LOCK*/
    ...
    */
    ...
    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = Db-ControlAgent * -1 pledgernarration = "Collect from Agent / " +  STRING(gi_data_airline_sum.CollectFromAgent,"-zz,zzz,zz9.99").
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Airlines Agent Commission" pledgeramount-debit1 = gi_data_airline_sum.Db-agentcomm * -1 pledgernarration = "Agent Comm. / " + STRING(gi_data_airline_sum.agentcomm,"-zz,zzz,zz9.99").
    RUN debit_entry.

    IF gi_data_airline_sum.total-db-cr-diff < 0 THEN DO:
        ASSIGN pledgername-debit1 = "Airlines Adjustment" pledgeramount-debit1 = gi_data_airline_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN debit_entry.

        
    END.
    
    IF gi_data_airline_sum.diffGP < 0 THEN DO:
        ASSIGN pledgername-debit1 = "Airline Sales" pledgeramount-debit1 = gi_data_airline_sum.diffGP * -1    pledgernarration = "Diff GP / " + STRING("").
        RUN debit_entry.
        ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum.diffGP pledgernarration = "Adjustment. / " + pacc-ledger-name-party + STRING(gi_data_airline_sum.diffGP,"-zz,zzz,zz9.99") .
        RUN credit_entry.
    END.      
    ...
    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum.cr-TopUp pledgernarration = "TopUp Amount". 
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Master Agent Commission Payable" pledgeramount-credit1 = gi_data_airline_sum.cr-MtAgentComm pledgernarration = "Master Agent". 
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum.cr-TransFee pledgernarration = "Tramsaction Fee". 
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum.cr-SupplierComm pledgernarration = "Supplier Comm". 
    RUN credit_entry.

    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_airline_sum.cr-PayableToAirline pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_airline_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.

    IF gi_data_airline_sum.total-db-cr-diff > 0 THEN DO:
        ASSIGN pledgername-credit1 = "Airlines Adjustment" pledgeramount-credit1 = gi_data_airline_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN credit_entry.

    END.

    IF gi_data_airline_sum.diffGP < 0 THEN DO:
        ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum.diffGP * -1   pledgernarration = "Diff GP / " + STRING("").
        RUN credit_entry.
        
        ASSIGN pledgername-debit1 = pacc-ledger-name-alias pledgeramount-debit1 = gi_data_airline_sum.diffGP pledgernarration = "Adjustment. / " + pacc-ledger-name-party + STRING(gi_data_airline_sum.diffGP,"-zz,zzz,zz9.99") .
        RUN debit_entry.
...
/*************************************
    ...
    /*************** DEBIT *****************/
        /*
    MESSAGE gi_data_airline_sum.db-agentcomm SKIP
         gi_data_airline_sum.CollectFromAgent
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
          */
    ASSIGN pledgername-debit1 = "Airlines Agent Commission" pledgeramount-debit1 = gi_data_airline_sum.db-agentcomm * -1 pledgernarration = "Agent Commission / " + STRING(gi_data_airline_sum.agentcomm,"-zz,zzz,zz9.99").
    RUN debit_entry.
    

    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_airline_sum.CollectFromAgent * -1 pledgernarration = "Collectable from Agent / " +  STRING(gi_data_airline_sum.CollectFromAgent,"-zz,zzz,zz9.99").
    RUN debit_entry.
    ...
    */
    ...
    /*
    MESSAGE gi_data_airline_sum.cr-topup
...
gi_data_airline_sum.PayableToAirline
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
      */
    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum.topupamt pledgernarration = "TopUp Amount / " + STRING(gi_data_airline_sum.topupamt,"-zz,zzz,zz9.99"). 
    RUN credit_entry.
    ...
    ASSIGN pledgername-credit1 = "Transaction Fee" pledgeramount-credit1 = gi_data_airline_sum.transfee pledgernarration = "Transac. Fee / " + STRING(gi_data_airline_sum.transfee,"-zz,zzz,zz9.99").
    RUN credit_entry.
    

    ASSIGN pledgername-credit1 = "Supplier Commission - Airline" pledgeramount-credit1 = gi_data_airline_sum.SupplierComm pledgernarration = "Supplier Comm. / " + STRING(gi_data_airline_sum.SupplierComm,"-zz,zzz,zz9.99").
    RUN credit_entry.
    ...
    */
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_airline_sum.PayableToAirline pledgernarration = replace(gi_data_airline_sum.iata,"&","&amp;") + " / " + pacc-ledger-name-party .
    RUN credit_entry.
