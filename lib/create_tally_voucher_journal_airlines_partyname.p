...
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons = pairline-sum-cons NO-LOCK
    ...
    */
    ...
    ASSIGN pledgername-credit1 = "Master Agent Commission Payable" pledgeramount-credit1 = gi_data_airline_sum.cr-mtagentcomm pledgernarration = "MTAgent Comm. / " + STRING(gi_data_airline_sum.mtagentcomm,"-zz,zzz,zz9.99").
    RUN credit_entry.
    ...
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_airline_sum.cr-PayableToAirline pledgernarration = replace(gi_data_airline_sum.iata,"&","&amp;") + " / " + pacc-ledger-name-party .
    RUN credit_entry.
