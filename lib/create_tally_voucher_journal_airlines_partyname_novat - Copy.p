...
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons = pairline-sum-cons NO-LOCK
    ...
    */
    ...
    ASSIGN pledgername-credit1 = "Airlines Agent Commission" pledgeramount-credit1 = gi_data_airline_sum.agentcomm1  pledgernarration = "Agent Commission / " + STRING(gi_data_airline_sum.agentcomm1,"-zz,zzz,zz9.99").
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Commission Income - Airline" pledgeramount-credit1 = gi_data_airline_sum.profit1  pledgernarration = "Profit / " + STRING(gi_data_airline_sum.profit1,"-zz,zzz,zz9.99").
    RUN credit_entry.
