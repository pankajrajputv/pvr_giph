...
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons = pairline-sum-cons NO-LOCK
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Airlines Agent Commission" pledgeramount-debit1 = 241234.78 * -1.
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = 170587280.08 * -1.
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Input Vat @ 12%" pledgeramount-debit1 = 28948.17 * -1.
    RUN debit_entry.
