...
FOR EACH gi_data_ecpay:
    ...
    FIND gi_data_ecpay_sum WHERE gi_data_ecpay_sum.YearMonthFN = gi_data_ecpay.YearMonth
    ...
    IF NOT AVAILABLE gi_data_ecpay_sum THEN DO:
        ...
        ASSIGN 
            ...
            gi_data_ecpay_sum.YearMonthFN = gi_data_ecpay.YearMonth
    ...
    ASSIGN
        gi_data_EcPay_sum.db-ControlAgent     = gi_data_ecpay_sum.TotalAmount - gi_data_EcPay_sum.AgentComm 


        gi_data_EcPay_sum.db-AgentComm      = gi_data_EcPay_sum.AgentComm 
        gi_data_EcPay_sum.cr-EcPayPurchases = gi_data_EcPay_sum.PayableToOperator
        gi_data_EcPay_sum.cr-EcPaySales     = gi_data_ecpay_sum.TotalAmount  - gi_data_EcPay_sum.PayableToOperator      
        .



    ASSIGN 
        gi_data_EcPay_sum.total-db         = gi_data_EcPay_sum.db-AgentComm      + gi_data_EcPay_sum.db-ControlAgent 
        gi_data_EcPay_sum.total-cr         = gi_data_EcPay_sum.cr-EcPayPurchases  + gi_data_EcPay_sum.cr-EcPaySales       
    ...
    ASSIGN
        gi_data_EcPay_sum.AutoGP = gi_data_EcPay_sum.cr-EcPaySales  - gi_data_EcPay_sum.db-AgentComm
          gi_data_EcPay_sum.DiffGP = gi_data_EcPay_sum.AutoGP  - gi_data_EcPay_sum.Profit 
        .
