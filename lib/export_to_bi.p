...
EXPORT DELIMITER "^"
        ...
        "VchId"
  .
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons > 0
                               AND gi_data_airline_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
        gi_data_airline_sum.AgentComm 
        0 /*gi_data_airline_sum.AgentComm1 */
        gi_data_airline_sum.airline-sum-cons 
        gi_data_airline_sum.BasicAmt 
        gi_data_airline_sum.CollectFromAgent 
        0 /*gi_data_airline_sum.CollectFromAgent1 */
        gi_data_airline_sum.IATAStock 
        0 /*gi_data_airline_sum.InputVat */
        gi_data_airline_sum.MTAgentComm 
        0 /*gi_data_airline_sum.MTAgentComm1 */
        0 /*gi_data_airline_sum.OutputVat */
...
EXPORT DELIMITER "^"
        ...
        "YearMonthFN"
  .
FOR EACH gi_data_airline_sum1 WHERE  gi_data_airline_sum1.airline-sum1-cons > 0
                                AND gi_data_airline_sum1.YearMonthFN <> "":
  EXPORT DELIMITER "^"
...
EXPORT DELIMITER "^"
    ...
    "DbCrDiff"                
  .
FOR EACH gi_data_hotel_sum WHERE gi_data_hotel_sum.hotel-sum-cons > 0
                             AND gi_data_hotel_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
    ...
    0  /*gi_data_hotel_sum.GrossAmount1        */
    0  /*gi_data_hotel_sum.AgentComm1          */
    0  /*gi_data_hotel_sum.MTAgentComm1        */
      gi_data_hotel_sum.InputVat            
    0  /*gi_data_hotel_sum.MTAgentComm2        */
    0  /*gi_data_hotel_sum.Payable1            */
    0  /*gi_data_hotel_sum.comm-income1        */
...
EXPORT DELIMITER "^"
    ...
    "MobileSumCons"
  .
FOR EACH gi_data_mobile_sum WHERE gi_data_mobile_sum.mobile-sum-cons > 0
                              AND gi_data_mobile_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
     ...
     0 /*gi_data_mobile_sum.GrossAmount1         */
     0 /*gi_data_mobile_sum.Payable1            */
     0 /*gi_data_mobile_sum.comm-income1        */
      ...
      gi_data_mobile_sum.mobile-sum-cons
      .
...
EXPORT DELIMITER "^"
    ...
    "DbCrDiff" 
  .
FOR EACH gi_data_ferry_sum WHERE gi_data_ferry_sum.ferry-sum-cons > 0
                             AND gi_data_ferry_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
      ...
      0 /*gi_data_ferry_sum.GrossAmount1           */
      0 /*gi_data_ferry_sum.AgentComm1             */
      gi_data_ferry_sum.InputVat               
      0 /*gi_data_ferry_sum.Payable1               */
      0 /*gi_data_ferry_sum.comm-income1           */
...
EXPORT DELIMITER "^"
    ...
    "DbCrDiff" 
  .
FOR EACH gi_data_insurance_sum WHERE gi_data_insurance_sum.insurance-sum-cons > 0
                                 AND gi_data_insurance_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
     ...
     0 /*gi_data_insurance_sum.GrossAmount1        */
     0 /*gi_data_insurance_sum.AgentComm1          */
      gi_data_insurance_sum.InputVat            
     0 /*gi_data_insurance_sum.Payable1            */
     0 /*gi_data_insurance_sum.comm-income1        */
...
EXPORT DELIMITER "^"
    ...
    "DbCrDiff" 
  .
FOR EACH gi_data_packages_sum WHERE gi_data_packages_sum.packages-sum-cons > 0
                                AND gi_data_packages_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
     ...
     0 /*gi_data_packages_sum.SellingPrice1        */
     0 /*gi_data_packages_sum.Payable1             */
     0 /*gi_data_packages_sum.MarkUp1              */
...
EXPORT DELIMITER "^"
    ...
    "EcPaySrNo"
  .
FOR EACH gi_data_ecpay_sum WHERE gi_data_ecpay_sum.ecpay-sum-cons > 0
                             AND gi_data_ecpay_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
     ...
     0 /*gi_data_ecpay_sum.GrossAmount1         */
     0 /*gi_data_ecpay_sum.AgentComm1           */
      gi_data_ecpay_sum.InputVat             
     0 /*gi_data_ecpay_sum.Payable1             */
     0 /*gi_data_ecpay_sum.comm-income1         */
...
EXPORT DELIMITER "^"
     ...
     "DbCrDiff" 
  .
FOR EACH gi_data_visa_sum WHERE gi_data_visa_sum.visa-sum-cons > 0
                            AND gi_data_visa_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
      ...
      0 /*gi_data_visa_sum.GrossAmount1          */
      0 /*gi_data_visa_sum.AgentComm1            */
      gi_data_visa_sum.InputVat              
      0 /*gi_data_visa_sum.comm-income1          */
      0 /*gi_data_visa_sum.Payable1              */
...
EXPORT DELIMITER "^"
    ...
    "DbCrDiff" 
  .
FOR EACH gi_data_bus_sum WHERE gi_data_bus_sum.bus-sum-cons > 0
                           AND gi_data_bus_sum.YearMonthFN <> "":
  EXPORT DELIMITER "^"
      ...
      0 /*gi_data_bus_sum.GrossAmount1          */
      0 /*gi_data_bus_sum.AgentComm1            */
      gi_data_bus_sum.InputVat              
      0 /*gi_data_bus_sum.comm-income1          */
      0 /*gi_data_bus_sum.Payable1              */
...
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons > 0
  ...
  EXPORT DELIMITER "^"
      ...
      0 /*gi_data_airline_sum.TransFee1 */
      0 /*gi_data_airline_sum.SupplierComm1 */
      0 /*gi_data_airline_sum.PayableToAirline1 */
      0 /*gi_data_airline_sum.OutputVat */
      gi_data_airline_sum.total-db 
      gi_data_airline_sum.total-cr 
      gi_data_airline_sum.total-db-cr-diff 
