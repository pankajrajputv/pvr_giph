DEF SHARED VAR pvisa-sum-cons LIKE gi_data_visa_sum.visa-sum-cons.
...
FOR EACH gi_data_visa_sum WHERE gi_data_visa_sum.visa-sum-cons = pvisa-sum-cons NO-LOCK
    BREAK BY gi_data_visa_sum.visa-sum-cons:
    
    /*
    FIND FIRST gi_data_visa WHERE gi_data_visa. gi_data_visa_sum NO-LOCK NO-ERROR.
    IF AVAILABLE gi_data_visa THEN DO:
        ASSIGN pvisasname = gi_data_visa.visasname.
    END.
    ELSE DO:
        ASSIGN pvisasname = "".
    END.
    */
    ...
    IF FIRST-OF(gi_data_visa_sum.visa-sum-cons) THEN DO:
        ASSIGN 
               pacc-ledger-name = replace(gi_data_visa_sum.party-name,"&","&amp;")
               pacc-ledger-name-party = replace(gi_data_visa_sum.party-name,"&","&amp;")
               pacc-ledger-parent-name = "Accounts Payable". 
        RUN CreateLedger.
        
        ASSIGN 
               pacc-ledger-name = replace(gi_data_visa_sum.alias-name,"&","&amp;")
               pacc-ledger-name-alias = replace(gi_data_visa_sum.alias-name,"&","&amp;")
               pacc-ledger-parent-name = "Accounts Payable". 
        RUN CreateLedger.


        RUN c:\pvr\giph\lib\Calc_Vou_Date_From_Fn.p(INPUT gi_data_visa_sum.YearMonth,OUTPUT pvoudate).

        ASSIGN 
            pvouchertype         = "Journal-Visa"
            pvouchernumber       = /*"CDV36462"*/ "JV-" + STRING(gi_data_visa_sum.visa-sum-cons,"999999")
            pvoucherdate         = /*10/31/19*/ pvoudate
            peffectivedate       = /*10/31/19*/ pvoudate
            pchequedate          = /*10/31/19*/ pvoudate
            pchequenumber        = /*STRING(gi_data_visa_sum.cheque-num)*/ ""
            ...
            pnarration           = replace(gi_data_visa_sum.party-name,"&","&amp;")
            .
        ...
        /*
                                    a9545bdc-3762-40ba-8917-ec660dcacc0e-0000ab16:00000068
                                    a9545bdc-3762-40ba-8917-ec660dcacc0e-00001ffd
                                    a9545bdc-3762-40ba-8917-ec660dcacc0e-00001ffd
          */
    ...
    END. /* IF FIRST-OF(gi_data_visa_sum.visa-sum-cons) */

    /*************** DEBIT *****************/

    ASSIGN pledgername-debit1 = "Agent Commission - Visa" pledgeramount-debit1 = gi_data_visa_sum.Db-agentcomm * -1 pledgernarration = "Agent Commission / " + STRING(gi_data_visa_sum.agentcomm,"-zz,zzz,zz9.99").
    RUN debit_entry.

    ASSIGN pledgername-debit1 = "Control Agent" pledgeramount-debit1 = gi_data_visa_sum.db-controlagent * -1 pledgernarration = "Coll from Agent - Agent Comm / " +  STRING((gi_data_visa_sum.CollectFromAgent),"-zz,zzz,zz9.99").
    RUN debit_entry.

    

    IF gi_data_visa_sum.diffGP > 0 THEN DO:
        ...
        ASSIGN pledgername-debit1 = "Visa Sales" pledgeramount-debit1 = gi_data_visa_sum.diffGP * -1  pledgernarration = "Diff GP / " + STRING("").
        RUN debit_entry.
    END.
      

    /*
    /*ASSIGN pledgername-debit1 = "Input Vat @ 12%" pledgeramount-debit1 = gi_data_visa_sum.inputvat * -1 pledgernarration = "Input Vat".*/
    ASSIGN pledgername-debit1 = "VAT Input Tax" pledgeramount-debit1 = gi_data_visa_sum.inputvat * -1 pledgernarration = "Input Vat".
    RUN debit_entry.
    

    IF gi_data_visa_sum.total-db-cr-diff < 0 THEN DO:
        /*ASSIGN pledgername-debit1 = "Income - Miscellaneous" pledgeramount-debit1 = gi_data_visa_sum.total-db-cr-diff * -1  pledgernarration = "Diff Db Cr / " + STRING("").*/
        ASSIGN pledgername-debit1 = "Income - Miscellaneous" pledgeramount-debit1 = gi_data_visa_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN debit_entry.
    END.
    */
    ...
    ASSIGN pledgername-credit1 = "Visa Sales" pledgeramount-credit1 = gi_data_visa_sum.cr-VisaSales pledgernarration = "MarkUp - Agent Comm / " + STRING(gi_data_visa_sum.markupamount,"-zz,zzz,zz9.99") + STRING(gi_data_visa_sum.agentcomm,"-zz,zzz,zz9.99"). 
    /*ASSIGN pledgername-credit1 = "Visa" pledgeramount-credit1 = gi_data_visa_sum.comm-income1 pledgernarration = "Gross Amt - Payable / " + STRING(gi_data_visa_sum.GrossAmount - gi_data_visa_sum.Payable,"-zz,zzz,zz9.99"). */
    RUN credit_entry.


    /*ASSIGN pledgername-credit1 = "Payable to Operate - Visa" pledgeramount-credit1 = gi_data_visa_sum.payable1 pledgernarration = "Payable. / " /*+ STRING(gi_data_visa_sum.mtagentcomm,"-zz,zzz,zz9.99") */.*/
    ASSIGN pledgername-credit1 = pacc-ledger-name-alias pledgeramount-credit1 = gi_data_visa_sum.cr-VisaPurchases pledgernarration = "Payable. / " + pacc-ledger-name-party /*+ STRING(gi_data_visa_sum.mtagentcomm,"-zz,zzz,zz9.99") */.
    RUN credit_entry.


    /*

    /*ASSIGN pledgername-credit1 = "Output Vat @ 12%" pledgeramount-credit1 = gi_data_visa_sum.outputvat pledgernarration = "Commission Income - Visa / x 0.12 " + STRING(gi_data_visa_sum.comm-income1, "-zz,zzz,zz9.99").*/
    ASSIGN pledgername-credit1 = "Output Tax Payable" pledgeramount-credit1 = gi_data_visa_sum.outputvat pledgernarration = "Commission Income - Visa / x 0.12 " + STRING(gi_data_visa_sum.comm-income1, "-zz,zzz,zz9.99").
    RUN credit_entry.
      */
    /*
    ASSIGN pledgername-credit1 = "Income - Miscellaneous" pledgeramount-credit1 = gi_data_visa_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
    RUN credit_entry.
    */

    IF gi_data_visa_sum.diffGP < 0 THEN DO:
        ASSIGN pledgername-credit1 = "Visa Sales" pledgeramount-credit1 = gi_data_visa_sum.diffGP * -1  pledgernarration = "Diff GP / " + STRING("").
        RUN credit_entry.
    END.


END. /* for each gi_data_visa_sum */
...
/*
FOR EACH gi_data_visa_sum WHERE gi_data_visa_sum.visa-sum-cons = pvisa-sum-cons:
    RUN c:\pvr\giph\lib\get_voucher_id.p(INPUT poutput-filename, OUTPUT pLastVchId, OUTPUT gi_data_visa_sum.tally-response).
    /*
    ASSIGN gi_data_visa_sum.LastVchId = pLastVchId.
    */
END.
*/
