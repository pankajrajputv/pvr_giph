...
FOR EACH gi_data_mobile:
    ...
    ASSIGN 
        ...
        .
      */
    FIND gi_data_mobile_sum WHERE gi_data_mobile_sum.YearMonthFN = gi_data_mobile.YearMonth
    ...
    IF NOT AVAILABLE gi_data_mobile_sum THEN DO:
        ...
        ASSIGN 
            ...
            gi_data_mobile_sum.YearMonthFN = gi_data_mobile.YearMonth
    ...
    ASSIGN 
         gi_data_mobile_sum.cr-MobilePurchases = gi_data_mobile_sum.Payable
         gi_data_mobile_sum.cr-MobileSales     = gi_data_mobile_sum.SupplierComm
         gi_data_mobile_sum.db-ControlAgent    = gi_data_mobile_sum.Collectable
         gi_data_mobile_sum.OutputVat        = gi_data_mobile_sum.OutputVat         + gi_data_mobile.OutputVat       
        .

    ASSIGN gi_data_mobile_sum.AutoGP = gi_data_mobile_sum.cr-MobileSales.
    ASSIGN gi_data_mobile_sum.DiffGP = gi_data_mobile_sum.Profit - gi_data_mobile_sum.cr-MobileSales .


    ASSIGN
        gi_data_mobile_sum.total-db         =  gi_data_mobile_sum.db-ControlAgent        
        gi_data_mobile_sum.total-cr         =  (gi_data_mobile_sum.cr-MobilePurchases  + gi_data_mobile_sum.cr-MobileSales)    
