...
FOR EACH gi_acc_hea /*WHERE gi_acc_hea.refnum1 = "cdv34405"*/
    /*NO-LOCK*/
    /*EACH gi_acc_det OF gi_acc_hea /*NO-LOCK*/*/
    BREAK BY gi_acc_hea.refnum1:

    IF FIRST-OF(gi_acc_hea.refnum1) THEN DO:
        n = 0.
        FOR EACH b_gi_acc_det OF gi_acc_hea NO-LOCK:
            ...
            IF n > 1 THEN DO:
                ...
                IF AVAILABLE b_gi_acc_hea THEN DO:
                    ...
                    ASSIGN b_gi_acc_hea.vouchertype = "Contra".
                    NEXT.
                END.
            END.
        ...
        FOR EACH b_gi_acc_det OF gi_acc_hea NO-LOCK:
            ...
            FIND gi_acc_led WHERE gi_acc_led.acc-led-name = b_gi_acc_det.acc-led-name NO-LOCK NO-ERROR.
            IF AVAILABLE gi_acc_led AND gi_acc_led.acc-led-name = "Advances from Client" THEN DO: /* */
                r = r + 1.
            END.
            IF r >= 1 AND b >= 1 THEN DO:
                FIND b_gi_acc_hea OF gi_acc_hea NO-ERROR.
                IF AVAILABLE b_gi_acc_hea THEN DO:
                    ASSIGN b_gi_acc_hea.isreceipt = TRUE.
                    ASSIGN b_gi_acc_hea.vouchertype = "Receipt".
                    NEXT.
                END.
            END.
        END. /* for each b_gi_acc_det */
        ...
        FOR EACH b_gi_acc_det OF gi_acc_hea NO-LOCK:
            ...
            IF p >= 1 THEN DO:
                ...
                IF AVAILABLE b_gi_acc_hea THEN DO:
                    ...
                    ASSIGN b_gi_acc_hea.vouchertype = "Purchase".
                    NEXT.
                END.
            END.
        END. /* for each b_gi_acc_det */
        ...
        FOR EACH b_gi_acc_det OF gi_acc_hea NO-LOCK:
            FIND gi_acc_led WHERE gi_acc_led.acc-led-name = b_gi_acc_det.acc-led-name NO-LOCK NO-ERROR.
            IF AVAILABLE gi_acc_led AND gi_acc_led.acc-led-name = "Advances to Employees" THEN DO: /* */
                p = p + 1.
            END.
            IF p >= 1 THEN DO:
                FIND b_gi_acc_hea OF gi_acc_hea NO-ERROR.
    ...
    FOR EACH gi_acc_hea WHERE gi_acc_hea.vouchertype = "":
        FOR EACH gi_acc_det OF gi_acc_hea WHERE gi_acc_det.acc-led-name = gi_acc_det.acc-led-name:
            IF gi_acc_det.debit > 0 THEN DO:
                ASSIGN gi_acc_hea.isjv = FALSE.
                ASSIGN gi_acc_hea.iscontra = FALSE.
                ASSIGN gi_acc_hea.ispayment = FALSE.
                ASSIGN gi_acc_hea.ispurchase = FALSE.
                ASSIGN gi_acc_hea.issales = FALSE.
            ...
            IF gi_acc_det.credit > 0 THEN DO:
                ASSIGN gi_acc_hea.isjv = FALSE.
                ASSIGN gi_acc_hea.iscontra = FALSE.
                ASSIGN gi_acc_hea.isreceipt = FALSE.
                ASSIGN gi_acc_hea.ispurchase = FALSE.
                ASSIGN gi_acc_hea.issales = FALSE.
...
END.
    ...
    FOR EACH gi_acc_hea: 
        IF gi_acc_hea.refnum1 BEGINS "JV" THEN DO: 
            ASSIGN gi_acc_hea.isjv = TRUE.
            ...
            ASSIGN gi_acc_hea.vouchertype = "Journal".

        END.

        IF gi_acc_hea.refnum1 BEGINS "SB" THEN DO: 
            ASSIGN gi_acc_hea.issales = TRUE.
            ...
            ASSIGN gi_acc_hea.vouchertype = "Sales".
        END.

        IF gi_acc_hea.refnum1 BEGINS "CRBSYS" THEN DO: 
            ASSIGN gi_acc_hea.isreceipt = TRUE.
