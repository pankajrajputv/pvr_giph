...
FOR EACH gi_data_airline_sum WHERE gi_data_airline_sum.airline-sum-cons = pairline-sum-cons NO-LOCK
    ...
    */
    ...
    /*************** DEBIT *****************/
    ASSIGN pledgername-debit1 = "Airlines Agent Commission" pledgeramount-debit1 = gi_data_airline_sum.agentcomm1 * -1 pledgernarration = "Agent Commission / " + STRING(gi_data_airline_sum.agentcomm1,"-zz,zzz,zz9.99").
    RUN debit_entry.
    ...
    ASSIGN pledgername-credit1 = "Airline Sales" pledgeramount-credit1 = gi_data_airline_sum.topupamt1 pledgernarration = "TopUp Amount / " + STRING(gi_data_airline_sum.topupamt,"-zz,zzz,zz9.99"). 
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Master Agent Commission Payable" pledgeramount-credit1 = gi_data_airline_sum.mtagentcomm1 pledgernarration = "MTAgent Comm. / " + STRING(gi_data_airline_sum.mtagentcomm,"-zz,zzz,zz9.99").
    RUN credit_entry.


    ASSIGN pledgername-credit1 = "Transaction Fee" pledgeramount-credit1 = gi_data_airline_sum.transfee1 pledgernarration = "Transac. Fee / " + STRING(gi_data_airline_sum.transfee,"-zz,zzz,zz9.99").
    RUN credit_entry.

    ASSIGN pledgername-credit1 = "Supplier Commission - Airline" pledgeramount-credit1 = gi_data_airline_sum.SupplierComm1 pledgernarration = "Supplier Comm. / " + STRING(gi_data_airline_sum.SupplierComm,"-zz,zzz,zz9.99").
    RUN credit_entry.
    ...
    IF gi_data_airline_sum.total-db-cr-diff > 0 THEN DO:
        ASSIGN pledgername-credit1 = "Income - Miscellaneous" pledgeramount-credit1 = gi_data_airline_sum.total-db-cr-diff  pledgernarration = "Diff Db Cr / " + STRING("").
        RUN credit_entry.
    END.
