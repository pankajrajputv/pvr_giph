    ...
    IF FIRST-OF(gi_data_banks.bank-cons) THEN DO:
        ...
        IF gi_data_banks.bank-code = "Aub" THEN DO:
            ...
            IF gi_data_banks.amt-cr > 0  THEN DO:
                IF gi_data_banks.ledger-cr MATCHES "*SEC*"  OR 
                   gi_data_banks.ledger-cr MATCHES "*BDO*"  OR
                   gi_data_banks.ledger-cr MATCHES "*PNB*"  OR
                   gi_data_banks.ledger-cr MATCHES "*MBTC*" OR
                   gi_data_banks.ledger-cr MATCHES "*BPI*"  OR
                   gi_data_banks.ledger-cr MATCHES "*UCPB*" THEN DO:     
                END.
                ELSE DO:
                    ASSIGN pacc-ledger-name = replace(gi_data_banks.ledger-cr,"&","&amp;")
                           pacc-ledger-parent-name = "Accounts Payable". 
                    RUN CreateLedger.
                END.
                ASSIGN pledgername-debit1  = gi_data_banks.bank-des
                       pledgername-credit1 = replace(gi_data_banks.ledger-cr,"&","&amp;").
            END.
            IF gi_data_banks.amt-db > 0  THEN DO:
                IF gi_data_banks.ledger-db MATCHES "*SEC*"  OR 
                   gi_data_banks.ledger-db MATCHES "*BDO*"  OR
                   gi_data_banks.ledger-db MATCHES "*PNB*"  OR
                   gi_data_banks.ledger-db MATCHES "*MBTC*" OR
                   gi_data_banks.ledger-db MATCHES "*BPI*"  OR
                   gi_data_banks.ledger-db MATCHES "*UCPB*" THEN DO:     
                END.
                ELSE DO:
                    ASSIGN pacc-ledger-name = replace(gi_data_banks.ledger-db,"&","&amp;")
                           pacc-ledger-parent-name = "Accounts Receivable". 
                    RUN CreateLedger.
                END.
                ASSIGN pledgername-debit1  = replace(gi_data_banks.ledger-db,"&","&amp;")
        ...
        IF gi_data_banks.bank-code = "BDO_Disbursement" THEN DO:
            ...
            IF gi_data_banks.amt-cr > 0  THEN DO:
                IF gi_data_banks.acc-payer MATCHES "*SEC*"  OR 
                   gi_data_banks.acc-payer MATCHES "*BDO*"  OR
                   gi_data_banks.acc-payer MATCHES "*PNB*"  OR
                   gi_data_banks.acc-payer MATCHES "*MBTC*" OR
                   gi_data_banks.acc-payer MATCHES "*BPI*"  OR
                   gi_data_banks.acc-payer MATCHES "*UCPB*" THEN DO:     
                END.
                ELSE DO:
                ...
                END.
                ASSIGN pledgername-debit1  = gi_data_banks.bank-des
                       pledgername-credit1 = replace(gi_data_banks.acc-payer,"&","&amp;").
                MESSAGE gi_data_banks.acc-payer
                    VIEW-AS ALERT-BOX INFO BUTTONS OK.
            END.
            IF gi_data_banks.amt-db > 0  THEN DO:
                IF gi_data_banks.acc-receiver MATCHES "*SEC*"  OR 
                   gi_data_banks.acc-receiver MATCHES "*BDO*"  OR
                   gi_data_banks.acc-receiver MATCHES "*PNB*"  OR
                   gi_data_banks.acc-receiver MATCHES "*MBTC*" OR
                   gi_data_banks.acc-receiver MATCHES "*BPI*"  OR
                   gi_data_banks.acc-receiver MATCHES "*UCPB*" THEN DO:     
                END.
                ELSE DO:
                    ...
                    RUN CreateLedger.
                END.
                ASSIGN pledgername-debit1  = replace(gi_data_banks.acc-receiver,"&","&amp;")
                       pledgername-credit1 = gi_data_banks.bank-des.
            END.
