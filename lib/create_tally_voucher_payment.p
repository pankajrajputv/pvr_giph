...
FOR EACH gi_acc_hea WHERE gi_acc_hea.refnum1 = prefnum1 
    ...
    IF gi_acc_det.debit > 0 THEN DO:
        ...
        ASSIGN 
            ...
            */
        ASSIGN 
            /*pledgername-debit1    = replace(gi_acc_det.partyname,"&","&amp;")*/
            pledgername-debit1    = replace(gi_acc_det.acc-led-name,"&","&amp;")
            pledgeramount-debit1  = /*3838.39 * -1*/ gi_acc_det.debit * -1
            pledgernarration = /*pledgername*/ replace(gi_acc_det.partyname,"&","&amp;")
            .
