...
FOR EACH gi_data_visa:
    ...
    ASSIGN 
      ...
      gi_data_visa.AgentComm1   = gi_data_visa.AgentComm / 1.12
      gi_data_visa.InputVat     = gi_data_visa.AgentComm1 * 0.12
        .

    ASSIGN 
      gi_data_visa.Payable1     = gi_data_visa.Payable
      gi_data_visa.comm-income1 = (gi_data_visa.GrossAmount - gi_data_visa.Payable) / 1.12 
      gi_data_visa.OutputVat    = gi_data_visa.comm-income * 0.12
        .
