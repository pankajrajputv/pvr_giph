...
FOR EACH gi_data_bus:
    ...
    ASSIGN 
      ...
      gi_data_bus.AgentComm1   = gi_data_bus.AgentComm / 1.12
      gi_data_bus.InputVat     = gi_data_bus.AgentComm1 * 0.12
        .

    ASSIGN 
      gi_data_bus.Payable1     = gi_data_bus.Payable
      gi_data_bus.comm-income1 = (gi_data_bus.GrossAmount - gi_data_bus.Payable) / 1.12 
      gi_data_bus.OutputVat    = gi_data_bus.comm-income1 * 0.12
        .
