...
FOR EACH gi_data_ferry:
    ...
    ASSIGN 
      ...
      gi_data_ferry.AgentComm1   = gi_data_ferry.AgentComm / 1.12
      gi_data_ferry.InputVat     = gi_data_ferry.AgentComm1 * 0.12
        .

    ASSIGN 
      gi_data_ferry.Payable1     = gi_data_ferry.Payable
      gi_data_ferry.comm-income1 = (gi_data_ferry.CollectFromAgent - gi_data_ferry.Payable) / 1.12 
      gi_data_ferry.OutputVat    = gi_data_ferry.comm-income * 0.12
        .

    ASSIGN 
      gi_data_ferry.total-db = gi_data_ferry.GrossAmount1 + gi_data_ferry.AgentComm1 + gi_data_ferry.InputVat       
      gi_data_ferry.total-cr = gi_data_ferry.Payable1 + gi_data_ferry.comm-income1 + gi_data_ferry.OutputVat 
      gi_data_ferry.total-db-cr-diff = gi_data_ferry.total-db - gi_data_ferry.total-cr
        .
    ...
    IF NOT AVAILABLE gi_data_ferry_sum THEN DO:
        ...
        ASSIGN 
            ...
            gi_data_ferry_sum.YearMonthFN = gi_data_ferry.YearMonthFN
    ...
    ASSIGN 
        gi_data_ferry_sum.GrossAmount1     = gi_data_ferry_sum.GrossAmount1      + gi_data_ferry.GrossAmount1    
        gi_data_ferry_sum.AgentComm1       = gi_data_ferry_sum.AgentComm1        + gi_data_ferry.AgentComm1      
        gi_data_ferry_sum.InputVat         = gi_data_ferry_sum.InputVat          + gi_data_ferry.InputVat        
        gi_data_ferry_sum.Payable1         = gi_data_ferry_sum.Payable1          + gi_data_ferry.Payable1        
        gi_data_ferry_sum.comm-income1     = gi_data_ferry_sum.comm-income1      + gi_data_ferry.comm-income1     
