...
gi_data_mobile_sum.LastVchId gi_data_mobile_sum.party-name ~
gi_data_mobile_sum.alias-name gi_data_mobile_sum.MrpValue ~
gi_data_mobile_sum.SupplierComm gi_data_mobile_sum.Payable ~
gi_data_mobile_sum.AgentComm gi_data_mobile_sum.Collectable ~
gi_data_mobile_sum.TotalTssComm gi_data_mobile_sum.Profit ~
gi_data_mobile_sum.db-ControlAgent gi_data_mobile_sum.total-db ~
gi_data_mobile_sum.cr-MobileSales gi_data_mobile_sum.cr-MobilePurchases ~
gi_data_mobile_sum.total-cr gi_data_mobile_sum.total-db-cr-diff ~
gi_data_mobile_sum.AutoGP gi_data_mobile_sum.DiffGP 
...
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH gi_data_mobile ~
      WHERE gi_data_mobile.YearMonth MATCHES pYearMonthFN1 ~
...
DEFINE MENU POPUP-MENU-BROWSE-1 
       ...
       MENU-ITEM m_Create_Mobile_Journal_Entry2 LABEL "Create Mobile Journal Entry - Final"
       RULE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 wWin _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      gi_data_mobile_sum.LastVchId FORMAT "->>>>>>9":U WIDTH 7.14
      ...
      gi_data_mobile_sum.SupplierComm COLUMN-LABEL "Supplier! Comm" FORMAT "->,>>>,>>>,>>9.99":U
            WIDTH 14
      gi_data_mobile_sum.Payable FORMAT "->,>>>,>>>,>>9.99":U WIDTH 14.57
      gi_data_mobile_sum.AgentComm COLUMN-LABEL "Agent! Comm" FORMAT "->,>>>,>>>,>>9.99":U
            WIDTH 14.86
      gi_data_mobile_sum.Collectable FORMAT "->,>>>,>>>,>>9.99":U
            WIDTH 11.72
      ...
      gi_data_mobile_sum.db-ControlAgent COLUMN-LABEL "Db!Control Agent" FORMAT "->,>>>,>>>,>>9.99":U
            WIDTH 12.72
      gi_data_mobile_sum.total-db COLUMN-LABEL "Total !Debit" FORMAT "->,>>>,>>>,>>9.99":U
            WIDTH 12.29 COLUMN-BGCOLOR 21
      gi_data_mobile_sum.cr-MobileSales COLUMN-LABEL "Cr !Mobile Sales" FORMAT "->,>>>,>>>,>>9.99":U
            WIDTH 12
      gi_data_mobile_sum.cr-MobilePurchases COLUMN-LABEL "Cr!Mobile Purch." FORMAT "->,>>>,>>>,>>9.99":U
            WIDTH 10.72
      ...
      gi_data_mobile_sum.AutoGP COLUMN-LABEL "Auto!GP" FORMAT "->,>>>,>>>,>>9.99":U
      gi_data_mobile_sum.DiffGP COLUMN-LABEL "Diff!GP" FORMAT "->,>>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fMain
     ...
     BtnExportFinal AT ROW 2.31 COL 145.43 WIDGET-ID 86
     BtnValidateNoVat AT ROW 2.31 COL 158 WIDGET-ID 84
     wyearmonthfn AT ROW 2.46 COL 13.86 COLON-ALIGNED WIDGET-ID 2
     wParty-Name AT ROW 2.46 COL 44.57 COLON-ALIGNED WIDGET-ID 8
     BtnSearch AT ROW 2.46 COL 73 WIDGET-ID 6
     BROWSE-1 AT ROW 3.69 COL 1.86 WIDGET-ID 300
...
"YearMonthFN" "Year Month!FN" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > giph.gi_data_mobile_sum.LastVchId
"LastVchId" ? ? "integer" ? ? ? ? ? ? no ? no no "7.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > giph.gi_data_mobile_sum.party-name
"party-name" "Party !Name" ? "character" ? ? ? ? ? ? no ? no no "31.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > giph.gi_data_mobile_sum.alias-name
"alias-name" ? ? "character" ? ? ? ? ? ? no ? no no "20" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > giph.gi_data_mobile_sum.MrpValue
"MrpValue" "MRP !Value" ? "decimal" ? ? ? ? ? ? no ? no no "15.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > giph.gi_data_mobile_sum.SupplierComm
"SupplierComm" "Supplier! Comm" ? "decimal" ? ? ? ? ? ? no ? no no "14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > giph.gi_data_mobile_sum.Payable
"Payable" ? ? "decimal" ? ? ? ? ? ? no ? no no "14.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > giph.gi_data_mobile_sum.AgentComm
"AgentComm" "Agent! Comm" ? "decimal" ? ? ? ? ? ? no ? no no "14.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > giph.gi_data_mobile_sum.Collectable
"Collectable" ? ? "decimal" ? ? ? ? ? ? no ? no no "11.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > giph.gi_data_mobile_sum.TotalTssComm
"TotalTssComm" "Total TSS! Comm" ? "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > giph.gi_data_mobile_sum.Profit
"Profit" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > giph.gi_data_mobile_sum.db-ControlAgent
"db-ControlAgent" "Db!Control Agent" ? "decimal" ? ? ? ? ? ? no ? no no "12.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > giph.gi_data_mobile_sum.total-db
"total-db" "Total !Debit" ? "decimal" 21 ? ? ? ? ? no ? no no "12.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > giph.gi_data_mobile_sum.cr-MobileSales
"cr-MobileSales" "Cr !Mobile Sales" ? "decimal" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > giph.gi_data_mobile_sum.cr-MobilePurchases
"cr-MobilePurchases" "Cr!Mobile Purch." "->,>>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"total-db-cr-diff" "Db Cr!Diff" ? "decimal" 21 ? ? ? ? ? no ? no no "8.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > giph.gi_data_mobile_sum.AutoGP
"AutoGP" "Auto!GP" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > giph.gi_data_mobile_sum.DiffGP
...
/* Query rebuild information for BROWSE BROWSE-2
     ...
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "giph.gi_data_mobile.YearMonth MATCHES pYearMonthFN1
  ...
  IF choice THEN DO:
     /* RUN c:\pvr\giph\lib\create_tally_voucher_journal_mobile.p.*/
      ...
      FOR EACH b_gi_data_mobile_sum WHERE b_gi_data_mobile_sum.YearMonthFn MATCHES wYearMonthFn
          ...
          ASSIGN n = n + 1.
          ASSIGN pmobile-sum-cons = b_gi_data_mobile_sum.mobile-sum-cons.
          RUN C:\pvr\giph\lib\create_tally_voucher_journal_mobile_partyname_final.p.
          RUN c:\pvr\giph\lib\get_voucher_id.p(INPUT poutput-filename, OUTPUT b_gi_data_mobile_sum.LastVchId, OUTPUT b_gi_data_mobile_sum.tally-response).
...
DO:
  ...
  MESSAGE "Validate the data?"            
      ...
      TITLE "" UPDATE choice AS LOGICAL.
  IF choice THEN DO:
      RUN c:\pvr\giph\lib\VALIDATE_mobile_data_novat.p.
  END.
  SESSION:SET-WAIT-STATE("").
  APPLY "Choose" TO BtnSearch.
...
ASSIGN pfilename = "c:\temp\gi_data_mobile_sum_total.txt".

FORM
    b_gi_data_mobile_sum.yearmonth
    ptotal-payable 
...
OUTPUT TO VALUE(pfilename).
    ...
    FOR EACH b_gi_data_mobile_sum WHERE b_gi_data_mobile_sum.yearmonth <> ""  NO-LOCK
        BREAK BY b_gi_data_mobile_sum.yearmonth WITH FRAME a DOWN:
    
        IF FIRST-OF(b_gi_data_mobile_sum.yearmonth) THEN DO:
            ASSIGN ptotal-payable = 0 ptotal-profit = 0.
        END.
        ASSIGN ptotal-payable = ptotal-payable + b_gi_data_mobile_sum.payable.
        ASSIGN ptotal-profit  = ptotal-profit + b_gi_data_mobile_sum.profit.
        ACCUMULATE b_gi_data_mobile_sum.payable(TOTAL).
        ACCUMULATE b_gi_data_mobile_sum.profit(TOTAL).
    
        IF LAST-OF(b_gi_data_mobile_sum.yearmonth) THEN DO:
            DISPLAY 
                b_gi_data_mobile_sum.yearmonth
                ptotal-payable 
                ptotal-profit
    ...
    END.
    DISPLAY 
        ACCUM TOTAL b_gi_data_mobile_sum.payable FORMAT "-z,zzz,zzz,zzz,zz9.99" 
        ACCUM TOTAL b_gi_data_mobile_sum.profit FORMAT "-z,zzz,zzz,zzz,zz9.99" 
        WITH FRAME a1.


    /*
    FOR EACH b_gi_data_mobile_sum WHERE b_gi_data_mobile_sum.yearmonth <> ""  NO-LOCK
        BREAK BY b_gi_data_mobile_sum.yearmonthfn WITH FRAME b DOWN:
    
        IF FIRST-OF(b_gi_data_mobile_sum.yearmonthfn) THEN DO:
            ASSIGN ptotal-payable-fn = 0.
        END.
        ASSIGN ptotal-payable-fn = ptotal-payable-fn + b_gi_data_mobile_sum.payable.
    

        IF LAST-OF(b_gi_data_mobile_sum.yearmonthfn) THEN DO:
            DISPLAY 
                b_gi_data_mobile_sum.yearmonth
                b_gi_data_mobile_sum.yearmonthfn
                ptotal-payable-fn 
...
&Scoped-define SELF-NAME m_Create_Mobile_Journal_Entry2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_Create_Mobile_Journal_Entry2 wWin
ON CHOOSE OF MENU-ITEM m_Create_Mobile_Journal_Entry2 /* Create Mobile Journal Entry - Final */
DO:
